...
def fix_question_with_more_space(q_num, next_q_num):
    """Fix a question with more space to include all options"""
    print(f"\n=== Extracting Q{q_num} (with full options) ===")
    for page_num in range(1, len(doc)):
        ...
        if q_y:
            ...
            if next_q_y:
                ...
                # Only stop 10px before next question (was 30px, too much)
                ...
                if next_q_y:
                    ...
                    extract_question(doc, q_num, page_num, q_y, page_num + 1, next_q_y - 10)
            break

# Fix Q24 (options are cut)
fix_question_with_more_space(24, 25)

# Fix Q34 (half of D option cut)
fix_question_with_more_space(34, 35)

# Fix Q39 (half of D option cut)
fix_question_with_more_space(39, 40)

doc.close()
print("\n[DONE] Q24, Q34, and Q39 re-extracted with full options")
