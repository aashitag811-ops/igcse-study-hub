...
SUBJECT_CONFIG = {
    ...
    # ── IGCSE Co-ordinated Sciences: Papers 1 & 2 = MCQ ─────────────────────
    "0654": {
        ...
        "has_diagrams": True,
        "image_folder": "0654",
        "note": "IGCSE Co-ordinated Sciences MCQ — P1 Core (40q), P2 Extended (40q)",
    },
    # ── IGCSE Computer Science: Paper 1 = MCQ ───────────────────────────────
    "0478": {
        ...
        "has_diagrams": False,
        "image_folder": "0478",
        "note": "IGCSE Computer Science MCQ — P1 40q text-based",
    },
    # ── IGCSE 9-1 Sciences: Papers 1 & 2 = MCQ ──────────────────────────────
    "0970": {
        "name": "Biology",
        "mcq_papers": [1, 2],
        "total_questions": {1: 40, 2: 40},
        ...
        "has_diagrams": True,
        "image_folder": "0970",
        "note": "IGCSE 9-1 Biology MCQ — P1 Core (40q), P2 Extended (40q)",
    },
    "0971": {
        "name": "Chemistry",
        "mcq_papers": [1, 2],
        ...
        "has_diagrams": True,
        "image_folder": "0971",
        "note": "IGCSE 9-1 Chemistry MCQ — P1 Core (40q), P2 Extended (40q)",
    },
    "0972": {
        "name": "Physics",
        "mcq_papers": [1, 2],
        ...
        "has_diagrams": True,
        "image_folder": "0972",
        "note": "IGCSE 9-1 Physics MCQ — P1 Core (40q), P2 Extended (40q)",
    },
    "0973": {
        "name": "Co-ordinated Sciences",
        "mcq_papers": [1, 2],
        ...
        "has_diagrams": True,
        "image_folder": "0973",
        "note": "IGCSE 9-1 Co-ordinated Sciences MCQ — P1 Core (40q), P2 Extended (40q)",
    },
    # ── IGCSE 9-1 Economics and Accounting: Paper 1 = MCQ ───────────────────
    "0987": {
        "name": "Economics",
        "mcq_papers": [1],
        "total_questions": {1: 30},
        ...
        "has_diagrams": False,
        "image_folder": "0987",
        "note": "IGCSE 9-1 Economics MCQ — P1 30q",
    },
    "0985": {
        "name": "Accounting",
        "mcq_papers": [1],
        ...
        "has_diagrams": False,
        "image_folder": "0985",
        "note": "IGCSE 9-1 Accounting MCQ — P1 30q",
    },
    # ── O-Level Sciences: Paper 1 = MCQ (40q) ───────────────────────────────
    "5090": {
        "name": "Biology",
        "mcq_papers": [1],
        "total_questions": {1: 40},
        ...
        "has_diagrams": True,
        "image_folder": "5090",
        "note": "O-Level Biology MCQ — P1 40q image-based",
    },
    "5070": {
        "name": "Chemistry",
        "mcq_papers": [1],
        ...
        "has_diagrams": True,
        "image_folder": "5070",
        "note": "O-Level Chemistry MCQ — P1 40q image-based",
    },
    "5054": {
        "name": "Physics",
        "mcq_papers": [1],
        ...
        "has_diagrams": True,
        "image_folder": "5054",
        "note": "O-Level Physics MCQ — P1 40q image-based",
    },
    # ── O-Level Commerce / Accounts: Paper 1 = MCQ (30q) ────────────────────
    "2281": {
        "name": "Economics",
        "mcq_papers": [1],
        "total_questions": {1: 30},
        ...
        "has_diagrams": False,
        "image_folder": "2281",
        "note": "O-Level Economics MCQ — P1 30q",
    },
    "7100": {
        "name": "Commerce",
        "mcq_papers": [1],
        ...
        "has_diagrams": False,
        "image_folder": "7100",
        "note": "O-Level Commerce MCQ — P1 30q",
    },
    "7110": {
        ...
        "has_diagrams": False,
        "image_folder": "7110",
        "note": "O-Level Principles of Accounts MCQ — P1 30q",
    },
    "7707": {
        "name": "Accounting",
        "mcq_papers": [1],
        ...
        "has_diagrams": False,
        "image_folder": "7707",
        "note": "O-Level Accounting MCQ — P1 30q",
    },
}
