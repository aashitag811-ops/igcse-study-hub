...
export default function Footer() {
  return (
    <footer className="relative bg-[#0A0806] dark:bg-[#0A0806] [data-theme='light']_&:bg-[#F9F5EB] border-t border-[#C9A84C]/20 py-12 px-6 transition-colors duration-500">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-8 border-t border-[#C9A84C]/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-sans text-xs text-[#7A6A4A] dark:text-[#7A6A4A] [data-theme='light']_&:text-[#5C4520]">
              © 2026 Student Archive. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <Link href="/privacy" className="font-sans text-xs text-[#7A6A4A] hover:text-[#C9A84C] dark:text-[#7A6A4A] dark:hover:text-[#C9A84C] [data-theme='light']_&:text-[#5C4520] [data-theme='light']_&:hover:text-[#8B6914] transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="font-sans text-xs text-[#7A6A4A] hover:text-[#C9A84C] dark:text-[#7A6A4A] dark:hover:text-[#C9A84C] [data-theme='light']_&:text-[#5C4520] [data-theme='light']_&:hover:text-[#8B6914] transition-colors">
                Terms of Service
              </Link>
            </div>
          </div>
