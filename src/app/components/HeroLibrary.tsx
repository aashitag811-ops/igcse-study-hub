...
const LANGUAGES: Subject[] = [
  ...
  },
  {
    ...
    code: '0510',
    description: 'Reading, writing and listening skills in English for non-native speakers.',
    color: '#5E3A20',
    spineWidth: 'w-[8%]',
  },
  {
...
const HUMANITIES: Subject[] = [
  ...
  },
  {
    ...
    title: 'Accounting',
    code: '0452',
    description: 'Financial accounting, double-entry bookkeeping, trial balances, final accounts and analysis.',
    color: '#1A3A2A',
    spineWidth: 'w-[7.5%]',
  },
  {
    ...
    code: '0478',
    description: 'Algorithms, data structures, programming, networks and databases.',
    color: '#1E2A3E',
    spineWidth: 'w-[7%]',
  },
  {
...
const MORE_SUBJECTS: Subject[] = [
  {
    ...
    title: 'History',
    code: '0470',
    description: 'Core content, depth studies, source-based analysis of 20th century history.',
    color: '#3A2A1A',
    spineWidth: 'w-[6.5%]',
  },
  {
    ...
    title: 'Geography',
    code: '0460',
    description: 'Geographical themes, skills, fieldwork and environmental issues.',
    color: '#2A3A2A',
    spineWidth: 'w-[7%]',
  },
  {
    ...
    code: '0448',
    description: 'Tourism industry, marketing, finance and global destinations.',
    color: '#2A3A4A',
    spineWidth: 'w-[7%]',
  },
];
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        ...
        >
          <div
            className="font-display text-xl font-medium mb-1 leading-snug"
